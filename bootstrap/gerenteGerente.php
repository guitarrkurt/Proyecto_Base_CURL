<?php
	...
	$query = "SELECT id, nombre, direccion, telefono, correo, estrellas, password FROM hotel";
	//Hacemos la consulta
...
<html>
	<head>
		<title> Gerente </title>
  		...
  		<tr>
  			<td align="center"><a href="indexGerente.php">Inicio</a></td>
  			<td align="center"><a href="turistaGerente.php">Turista</a></td>
  			<td align="center"><a href="gerenteGerente.php">Gerente</a></td>
  		</tr>
  		</table>
  		<!-- EOF -->
	</head>
	...
	<body>
      ...
      <a href="agregarGerente.php">Agregar Usuario</a>
      </br>
      <!-- Cerramos Sesión -->
      <a href="cerrarSesionGerente.php">Cerrar Sesión</a>
          ...
          <td><center><b>Password</b></center></td>
            ...
            <td>
              <?php echo $row["password"];?>
   					...
   					<td>
   						<a href="actualizarGerente.php?id=<?php echo $row["id"]; ?>">Actualizar</a>
   					</td>
   				  	<td>
   						<a href="bajaGerente.php?id=<?php echo $row["id"]; ?>">Baja</a>
   					</td>
   				</tr>
   				<?php } ?>	
   			</tbody>	
